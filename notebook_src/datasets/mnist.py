...
class ImageDatasetModule(object):
    ...
    def split_dataset(self, data_list, target_list):
        ...
        val_ood_train_dataset = ImageDataset(data=val_ood_train_data_list, targets=val_ood_train_target_list, transform=self.transform)
        val_ood_val_dataset = ImageDataset(data=val_ood_val_data_list, targets=val_ood_val_target_list, transform=self.transform)
        val_ood_test_dataset = ImageDataset(data=val_ood_test_data_list, targets=val_ood_test_target_list, transform=self.transform)
        ...
        test_ood_train_dataset = ImageDataset(data=test_ood_train_data_list, targets=test_ood_train_target_list, transform=self.transform)
        test_ood_val_dataset = ImageDataset(data=test_ood_val_data_list, targets=test_ood_val_target_list, transform=self.transform)
        test_ood_test_dataset = ImageDataset(data=test_ood_test_data_list, targets=test_ood_test_target_list, transform=self.transform)
