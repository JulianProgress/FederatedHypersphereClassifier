...
def create_datasets(file_name='nBaIoT_portion10',DATA_PATH='/workspace/data/add/data/nBaIoT/', train_portion=0.8, anomaly_portion=0.3,
    ...
    ), '/workspace/code/data/{}.pkl'.format(file_name))
