#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Created   : 2022/02/25 11:24
# @Author    : Junhyung Kwon
# @Site      : 
# @File      : DeepSAD_trainer.py
# @Software  : PyCharm

from notebook_src.base import BaseTrainer, BaseNet
...
class DeepSADTrainer(BaseTrainer):
    ...
    def train(self, train_loader, valid_loader, net: BaseNet):
    ...
    def test(self, test_loader, net: BaseNet):
        logger = logging.getLogger()
