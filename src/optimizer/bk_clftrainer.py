#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Created   : 2022/02/26 17:36
# @Author    : Junhyung Kwon
# @Site      : 
# @File      : bk_clftrainer.py
# @Software  : PyCharm
...
class CLFTrainer(BaseTrainer):
    def __init__(self, optimizer_name: str, lr: float, n_epochs: int, lr_milestones: tuple,
        ...
        super(CLFTrainer, self).__init__(optimizer_name, lr, n_epochs, lr_milestones, weight_decay, device)
    ...
    def train(self, dataset: DataLoader, validset: DataLoader, net: BaseNet):
        ...
        for epoch in range(self.n_epochs):
            ...
            for i, data in enumerate(dataloader):
                ...
                loss = torch.nn.functional.binary_cross_entropy_with_logits(input=svdd_out.squeeze(), target=y)
            ...
            for data in validset:
                ...
                val_loss = torch.nn.functional.binary_cross_entropy_with_logits(input=svdd_out.squeeze(), target=y)
        ...
        return deepcopy(net), num_examples_train
